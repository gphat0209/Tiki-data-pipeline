...
def id_crawler():
    ...
    df_id.to_csv('data/product_id.csv', index=False) 
    return "Product id crawling succeeded"
...
def info_crawler():
    ...
    df_product.to_csv('data/crawled_data.csv', index=False)
    return "Product info crawling succeeded"
